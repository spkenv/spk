...
//     pub fn list_packages(self) -> Iterable[str]:

//         path = "spk/spec"
//         return list(self._repo.tags.ls_tags(path))

//     @lru_cache()
//     pub fn list_package_versions(self, name: str) -> Iterable[str]:
...
//     @lru_cache()
//     pub fn list_package_builds(self, pkg: Union[str, api.Ident]) -> Iterable[api.Ident]:
...
//     pub fn force_publish_spec(self, spec: api.Spec) -> None:
...
//     pub fn publish_spec(self, spec: api.Spec) -> None:
...
//     @lru_cache()
//     pub fn read_spec(self, pkg: api.Ident) -> api.Spec:
...
//     pub fn remove_spec(self, pkg: api.Ident) -> None:
...
//     pub fn publish_package(self, spec: api.Spec, digest: spkrs.Digest) -> None:
...
//     pub fn get_package(self, pkg: api.Ident) -> spkrs.Digest:
...
//     pub fn remove_package(self, pkg: api.Ident) -> None:
...
//     pub fn build_package_tag(self, pkg: api.Ident) -> str:
...
//     pub fn build_spec_tag(self, pkg: api.Ident) -> str:
