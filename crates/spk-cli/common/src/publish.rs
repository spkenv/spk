...
impl Publisher {
    ...
    /// Skip existing package version checking when publishing a build
    /// for a package that was previously generated by an spk convert
    /// command.
                ...
                if self.force {
                    ...
                    match self.to.publish_recipe(&recipe).await {
                        ...
                        Err(spk_storage::Error::VersionExists(dest_recipe_ident)) => {
                            ...
                            if self.skip_existing && dest_recipe.metadata().is_spk_generated() {
                                ...
                                tracing::info!("Package version exists, skip-existing specified, and existing package was generated: publishing new builds allowed");
                            } else {
                                match pkg.build() {
