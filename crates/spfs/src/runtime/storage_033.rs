...
///! Local file system storage of runtimes (up to and including v0.33.x).
use std::ffi::OsStr;
...
impl Runtime {
    ...
    pub fn replicate(&mut self, future: &super::Runtime) -> Result<()> {
        self.config.editable = future.status.editable;
