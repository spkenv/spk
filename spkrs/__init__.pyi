...
def load_spec(pkg: api.Ident) -> api.Spec: ...
def save_spec(sepc: api.Spec) -> None: ...

class Publisher:
    def __init__(self) -> None: ...
    def with_source(self, source: storage.Repository) -> Publisher: ...
    def with_target(self, target: storage.Repository) -> Publisher: ...
    def skip_source_packages(self, skip_source_packages: bool) -> Publisher: ...
    def force(self, force: bool) -> Publisher: ...
    def publish(self, pkg: api.Ident) -> List[api.Ident]: ...
